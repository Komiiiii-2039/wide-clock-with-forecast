...
export default function Home() {
  return (
    <>
      <ThemeSwitcher />
      <main className="flex h-screen flex-col items-center justify-center bg-[var(--bg-color)] p-4">
        <div className="flex h-full w-full max-w-screen-2xl flex-row items-stretch justify-center gap-4 p-4 sm:p-6 lg:p-8">
          ...
          {/* Weather Section (40%) */}
          <div className="flex flex-[2] items-center justify-center rounded-md p-4 pt-8">
            <Weather />
          </div>
        </div>
      </main>
